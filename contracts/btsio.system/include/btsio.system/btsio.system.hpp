...
namespace eosiosystem {
   ...
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name token_account{"bts.token"_n};
         static constexpr eosio::name ram_account{"bts.ram"_n};
         static constexpr eosio::name ramfee_account{"bts.ramfee"_n};
         static constexpr eosio::name stake_account{"bts.stake"_n};
         static constexpr eosio::name bpay_account{"bts.bpay"_n};
         static constexpr eosio::name vpay_account{"bts.vpay"_n};
         static constexpr eosio::name names_account{"bts.names"_n};
         static constexpr eosio::name saving_account{"bts.saving"_n};
         static constexpr eosio::name rex_account{"bts.rex"_n};
         static constexpr eosio::name null_account{"bts.null"_n};
         ...
         static symbol get_core_symbol( name system_account = "btsio"_n ) {
